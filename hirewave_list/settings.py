"""
Django settings for hirewave_list project.
...
SECRET_KEY = 'django-insecure-#74^lyeeqv4=+0=p5=vyftbth$c0a)-)q=*yybu8j1w0&ymhky'
...
MIDDLEWARE = [
    ...
    'accounts.middleware.UniqueVisitorMiddleware',
...
WSGI_APPLICATION = 'hirewave_list.wsgi.application'
